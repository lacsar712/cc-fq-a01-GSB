...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/pairs/new', name: 'pair-submit', component: PairSubmitPage, meta: { bioops: true } },
    { path: '/pairs', name: 'pairs', component: PairHistoryPage },
    { path: '/pairs/:id', name: 'pair-detail', component: PairDetailPage },
  ],
})
